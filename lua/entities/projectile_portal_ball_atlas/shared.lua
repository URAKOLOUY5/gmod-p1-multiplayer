...
PrecacheParticleSystem("portal_1_projectile_ball_atlas")
PrecacheParticleSystem("portal_2_projectile_ball_atlas")
PrecacheParticleSystem("portal_1_projectile_stream_atlas")
PrecacheParticleSystem("portal_2_projectile_stream_atlas")
...
function ENT:SetEffects(type)
	...
	ParticleEffectAttach("portal_"..type.."_projectile_ball_atlas",PATTACH_ABSORIGIN_FOLLOW,self,1)
	ParticleEffectAttach("portal_"..type.."_projectile_fiber_atlas",PATTACH_ABSORIGIN_FOLLOW,self,1)
