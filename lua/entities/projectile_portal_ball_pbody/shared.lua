...
PrecacheParticleSystem("portal_1_projectile_ball_pbody")
PrecacheParticleSystem("portal_2_projectile_ball_pbody")
PrecacheParticleSystem("portal_1_projectile_stream_pbody")
PrecacheParticleSystem("portal_2_projectile_stream_pbody")
...
function ENT:SetEffects(type)
	...
	ParticleEffectAttach("portal_"..type.."_projectile_ball_pbody",PATTACH_ABSORIGIN_FOLLOW,self,1)
	ParticleEffectAttach("portal_"..type.."_projectile_fiber_pbody",PATTACH_ABSORIGIN_FOLLOW,self,1)
