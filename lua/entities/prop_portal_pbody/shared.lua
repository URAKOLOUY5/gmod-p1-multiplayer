...
function ENT:SetUpEffects(int)
	...
	ent:SetPos(pos)
	ent:SetAngles(ang)
	if int == TYPE_Yellow then
		ent:SetKeyValue( "effect_name", "portal_1_edge_pbody")
	elseif int == TYPE_Red then
...
hook.Add( "PhysgunPickup", "NoPickupPortalspbody", PlayerPickup )
hook.Add( "GravGunPickupAllowed", "NoPickupPortalspbody", PlayerPickup )
hook.Add( "GravGunPunt", "NoPickupPortalspbody", PlayerPickup )